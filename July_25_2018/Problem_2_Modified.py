...
class Calculator:
    ...
    def __init__(self, master):
        ...
        button_eqs = Button(frame, text='=', comman= self.evaluate)
        ...
        master.bind('0', self.add)
        master.bind('1', self.add)
        master.bind('2', self.add)
        master.bind('3', self.add)
        master.bind('4', self.add)
        master.bind('5', self.add)
        master.bind('6', self.add)
        master.bind('7', self.add)
        master.bind('8', self.add)
        master.bind('9', self.add)
        master.bind('.', self.add)
        master.bind('/', self.add)
        master.bind('*', self.add)
        master.bind('-', self.add)
        master.bind('+', self.add)
